...
class ValidationException extends AnzuException
{
    ...
    public const ERROR_ID_MISMATCH = 'error_id_mismatch';
    public const ERROR_FIELD_EMPTY = 'error_field_empty';
    public const ERROR_FIELD_LENGTH_MIN = 'error_field_length_min';
    public const ERROR_FIELD_LENGTH_MAX = 'error_field_length_max';
    public const ERROR_FIELD_INVALID = 'error_field_invalid';
    public const ERROR_FIELD_UNIQUE = 'error_field_not_unique';
    public const ERROR_FIELD_VALUE_NOT_FOUND = 'error_field_value_not_found';
    public const ERROR_FIELD_RANGE_MIN = 'error_field_range_min';
    public const ERROR_FIELD_RANGE_MAX = 'error_field_range_max';
    public const ERROR_FIELD_REGEX = 'error_field_regex';
    public const ERROR_FIELD_URL = 'error_field_url';
